...
# -------------------------
COMMANDS=(
    "./rvvTest-gemmini 3 8 8 8 1 1 0 0 0 20"
    "./rvvTest-gemmini 3 16 16 16 1 1 0 0 0 20"
    "./rvvTest-gemmini 3 32 32 32 1 1 0 0 0 20"
    "./rvvTest-gemmini 3 64 64 64 1 1 0 0 0 20"
    "./rvvTest-gemmini 3 128 128 128 1 1 0 0 0 20"
    "./rvvTest-gemmini 3 256 256 256 1 1 0 0 0 20"
    "./rvvTest-gemmini 1 32 1 1 0 20"
    "./rvvTest-gemmini 1 64 1 1 0 20"
    "./rvvTest-gemmini 1 128 1 1 0 20"
    "./rvvTest-gemmini 1 256 1 1 0 20"
    "./rvvTest-gemmini 1 512 1 1 0 20"
    "cd OpenVINS"
    "./run_illixr_msckf-gemmini data/mav0/cam0/data.csv data/mav0/cam1/data.csv data/mav0/imu0/data.csv data/mav0/cam0/data data/mav0/cam1/data"
...
while true; do
    ...
    if [ "$logged_in" = true ] && [ "$commands_executed" = false ]; then
        ...
        screen -S "$SESSION" -X hardcopy -h "$OUTDIR/vio_gemmini.txt"
        cleanup
