...
# -------------------------
COMMANDS=(
    "./rvvTest-generic 3 8 8 8 1 1 0 0 0 20"
    "./rvvTest-generic 3 16 16 16 1 1 0 0 0 20"
    "./rvvTest-generic 3 32 32 32 1 1 0 0 0 20"
    "./rvvTest-generic 3 64 64 64 1 1 0 0 0 20"
    "./rvvTest-generic 3 128 128 128 1 1 0 0 0 20"
    "./rvvTest-generic 3 256 256 256 1 1 0 0 0 20"
    "./rvvTest-generic 1 32 1 1 0 20"
    "./rvvTest-generic 1 64 1 1 0 20"
...
while true; do
    ...
    if [ "$logged_in" = true ] && [ "$commands_executed" = false ]; then
        ...
        screen -S "$SESSION" -X hardcopy -h "$OUTDIR/vio_generic.txt"
        cleanup
